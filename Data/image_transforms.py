...
class Image_Transforms:
    ...
    train_transform_with_padding = alb.Compose(
                    [
                        ...
                        alb.ImageCompression(95, p=.3),
                        alb.ToGray(always_apply=True),
                        alb.augmentations.geometric.resize.LongestMaxSize(max_size=512, interpolation=cv2.INTER_CUBIC,
                        ...
                        alb.PadIfNeeded(always_apply=True, min_height=200, min_width=512, border_mode=cv2.BORDER_CONSTANT, value=255),
    ...
    test_transform_with_padding = alb.Compose(
        ...
        [ alb.augmentations.geometric.resize.LongestMaxSize (max_size=512, interpolation=cv2.INTER_CUBIC, always_apply=False, p=1),
